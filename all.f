...
: FSEL A / 4 * GPFSEL0 + ;
: FUNCTION DUP FSEL 2DUP SWAP MASK3 SWAP @ AND ROT ;
...
: ALERT BEGIN 100 MSEC RED BLINK_BUZ BREAK_BUTTON IS_CLICKED UNTIL LEDS_OFF ALARM_OFF 1 SEC DELAY RESET QUIT ;
